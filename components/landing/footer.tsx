  ...
  return (
    <footer className="relative mt-12 border-t py-10">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center justify-between gap-4 text-sm text-muted-foreground md:flex-row">
        <p>© {new Date().getFullYear()} CognitiveTrace</p>
        <nav className="flex items-center gap-4">
          <Link href="#como-funciona" className="hover:text-foreground">Cómo funciona</Link>
          <Link href="#caracteristicas" className="hover:text-foreground">Características</Link>
          <Link href="#comenzar" className="hover:text-foreground">Comenzar</Link>
        </nav>
      </div>
    </footer>
  );
